...
<div class="form-group">
    ...
    <label for="name">Student Name:</label>
				...
				<input style="width: 450px" placeholder="Enter the Name of Student" type="text"
    ...
    <label for="age">Student Age:</label>
				...
				<input style="width: 450px" placeholder="Enter the Student Age" type="number"
					class="form-control" size="20" name="age">
			</div>
